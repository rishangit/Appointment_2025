...
const Calendar: React.FC = () => {
  ...
  const fetchAppointments = async () => {
    setLoading(true)
    try {
      const response = await companyAPI.getAppointments()
  ...
  return (
    <div className="container">
      <div className="page-header">
        ...
        <p>View and manage appointments in calendar format</p>
      </div>
        ...
        <div className="card-header">
          <div className="header-content">
            ...
            <div className="header-actions">
              <Button 
                variant="outline"
                onClick={() => navigate('/company/appointments')}
              >
                📋 List View
              </Button>
              <Button 
            ...
            <div className="modal-body">
              <div className="event-details">
                <div className="detail-row">
                  ...
                  <div>
                    <div className="font-weight-bold">{selectedEvent.user_name}</div>
                    <div className="text-muted">{selectedEvent.user_email}</div>
                  </div>
                </div>
              ...
              <div className="action-buttons">
                {selectedEvent.status === 'pending' && (
                  <>
                    <Button
                      variant="success"
                      onClick={() => updateAppointmentStatus(selectedEvent.id, 'scheduled')}
                    >
                      Accept
                    </Button>
                    <Button
